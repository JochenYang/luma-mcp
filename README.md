...
- **简单设计**: 单一 `image_understand` 工具处理所有图片分析任务
...
1. 使用完整工具名：`使用 mcp__luma-mcp__image_understand 工具分析这张图片`
2. 使用简化名称：`用 image_understand 工具查看 ./screenshot.png`
...
Claude: [自动调用 image_understand 工具]
```
